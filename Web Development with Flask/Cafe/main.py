...
class Cafe(db.Model):
    ...
    def to_dict(self):
        """"A function that returns a dictionary of column data"""
...
def get_random():
    """"Read from the database and return a random cafe"""
...
def add_cafe():
    # I did this with Postman, no HTML/WTForm was created
    # Make sure that the arguments in the get function match the keys in Postman
    new_cafe = Cafe(
    ...
    db.session.commit()
    return jsonify(response={"success": "Successfully added to the database"})
